...
for f in "${FRACTIONS[@]}"; do
    uv run run_detect.py \
        --model_name Qwen/Qwen3-14B \
        --fraction "$f" \
        --input_file /home/tianyichen/llm_watermark/outputs/only_eng/incontext_vllm/Qwen-Qwen3-14B/Qwen-Qwen3-14B_frac_"$f"_len_500_num_512_incontext_vllm_only_English.jsonl \
        --only_English \
        --combine_fraction
done
