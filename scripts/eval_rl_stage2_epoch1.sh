#!/bin/bash
# Post-epoch-1 evaluation for RL Stage 2 run (green+initials, 2-task GRPO).
# Mirrors eval_v5c_pipeline.sh; only RUN_TAG / CKPT_ROOT / STEPS differ.
# v5b ckpt 已有 baseline results; compare against its evaluation.csv for delta.
set -e
