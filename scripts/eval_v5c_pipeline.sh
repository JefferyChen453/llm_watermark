#!/bin/bash
# Post-training evaluation for v5c run (biased-ref KL top-K=500 within english).
# Single-variable delta vs v5b (K=1000): same data, same steps, only K differs.
set -e
...
RUN_TAG=v5c_green3379+initials865+neg1000_dualKL_biasedRefTopK500_202604182050
