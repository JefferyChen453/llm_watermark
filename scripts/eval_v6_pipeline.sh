#!/bin/bash
# Post-training evaluation for v6 run (green-only @ fraction=0.2, topK=1000).
# Data-axis ablation of v5b: same K=1000, same config, only train data narrowed
# to green@f=0.2 + initials + neg (3293 rows, 411 steps).
set -e
...
RUN_TAG=v6_greenF02_initials865_neg1000_dualKL_topK1000_202604190902
