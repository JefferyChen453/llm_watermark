#!/bin/bash
# Post-training evaluation for v5b run (biased-ref KL top-K=1000 within english).
...
# Single-variable delta vs v3 step_655 (same data, same config, only biased-ref top-K added).
set -e
...
RUN_TAG=v5b_green3379+initials865+neg1000_dualKL_biasedRefTopK1000_202604180857
