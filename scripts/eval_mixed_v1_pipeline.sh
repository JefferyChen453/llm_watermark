#!/bin/bash
# Post-training evaluation for mixed-kd v1 run (green5931 + initials865 + neg1000).
# Compares 2 ckpts (global_step_974, global_step_1948) against Qwen3-14B baseline.
...
RUN_TAG=mixed_green5931+initials865+neg1000_dualKL_202604160934
...
# that each call AutoTokenizer.from_pretrained (transformers' is_base_mistral()
# hits https://huggingface.co/api/models/... per worker).
...
# Baseline (only regenerate if missing)
